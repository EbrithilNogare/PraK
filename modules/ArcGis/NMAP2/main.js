...
const getActiveYear = () =>
  $("yearsDatalist").getElementsByTagName("option")[
...
const layersByYears = [
  {
    ...
    layers: [
      {
        layerID: "28d600499c6d4060a6a2f8bea020d304",
        opacity: 1.0,
        name: "ORP",
        featureLayer: null,
      },
      ...
      {
        layerID: "ad56bf8c2b4546f9b700cc976f3933b4",
        opacity: 1.0,
        name: "zeleznice",
        featureLayer: null,
      },
      {
        layerID: "697d67d7a37946b4943e0ead9b61a474",
        opacity: 1.0,
        name: "silnice",
        featureLayer: null,
      },
  ...
  },
  {
    ...
    layers: [
      {
        layerID: "901ffd24c6d0482e9200a3baa2204c61",
        opacity: 1.0,
        name: "ORP",
        featureLayer: null,
      },
      ...
      {
        layerID: "92d4feb6383a482bac2542c2d703b660",
        opacity: 1.0,
        name: "zeleznice",
        featureLayer: null,
      },
      {
        layerID: "e3a18dddaea842e880293449a06e1d77",
        opacity: 1.0,
        name: "silnice",
        featureLayer: null,
      },
  ...
  },
  {
    ...
    layers: [
      {
        layerID: "ac86e367126b456cbd926954e2873d0e",
        opacity: 1.0,
        name: "ORP",
        featureLayer: null,
      },
      ...
      {
        layerID: "edc33f5035ef49d2aa250b963df14238",
        opacity: 1.0,
        name: "zeleznice",
        featureLayer: null,
      },
      {
        layerID: "92eabea5425345eaab1e86feda8db7de",
        opacity: 1.0,
        name: "silnice",
        featureLayer: null,
      },
  ...
  },
  {
    ...
    layers: [
      {
        layerID: "3c14e174a5d24ba2bbc454b9b5edb7c8",
        opacity: 1.0,
        name: "ORP",
        featureLayer: null,
      ...
      {
        layerID: "6883b5fcc8644287a7c3fed92176437f",
        opacity: 1.0,
        name: "zeleznice",
        featureLayer: null,
      },
      {
        layerID: "b196d475d1b34975b44942ab390bf003",
        opacity: 1.0,
        name: "silnice",
        featureLayer: null,
      },
...
const getLayersFromButtons = ["ORP", "obceSouc", "zeleznice", "silnice"];
let loadingProgress = {
  value: 0,
  max: [].concat(
    ...layersByYears.map((layerByYear) => layerByYear.layers.map((layer) => 0))
  ).length,
};
...
require([
  ...
  const createFL = (layer) => {
    if (layer.featureLayer !== null && layer.featureLayer !== undefined) return;
  ...
  const concatedLayers = [].concat(
    ...layersByYears.map((layerByYear) =>
      layerByYear.layers.map((layer) => layer.featureLayer)
    )
  );
  ...
  function doDelete() {
    ...
    var activeCheckBox = document.querySelectorAll(
...
function layersFromButtonsChanged() {
  layersByYears[parseInt($("rokyRange").value)].layers.forEach((layer) => {
    if (!getLayersFromButtons.includes(layer.name)) return;
...
function changeYearDelta(delta) {
  ...
  if (newValue < 0 || newValue >= op.length) return;
  changeYear(newValue);
}
...
function changeYear(newValue) {
  ...
  $("rokShow").innerText = getActiveYear();
  cngRok(newValue);
...
moduly["1"] = [
  ...
  [
    "Podnik samosprávného celku (městský, komunální, okresní, krajský, zemský)",
    "Forma_podn",
  ],
