...
\section{Server}
Stroj, na kterém \uv{běží} aktuální verze systému je pod systémem Linux (přesněji Ubuntu).
...
\subsection{Stránka}
Zobrazení stránky též nevyžaduje žádná práva, ale k jejich vytváření je třeba mít roli tzv. \uv{CMS editor}, která,
...
je výsledkem spojení hesla a \uv{soli} (anglicky \textit{salt} - termín pro náhodný text pro zvýšení bezpečnosti proti bruteforce útoku) a
