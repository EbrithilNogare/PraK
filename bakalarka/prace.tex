...
The goal is to describe and use modern technologies into a working application,
...
A clear API is created on the server to provide all the data not only for the
