...
class UserInfo extends React.Component {
    ...
    Logout() {
        ...
        this.props.enqueueSnackbar('Odhlášení úspěšné', {
            variant: 'success',
    ...
    render() {
        return (
            <div>
                ...
                <p>
                    <b>ID:</b> {this.props.cookies.get('userID')}
                </p>
                <p>
                    <b>Přihlášený uživatel:</b> {this.props.cookies.get('user')}
                </p>
                <p>
                    <b>Práva: </b>{' '}
                </p>
                <ul>
                    {this.props.cookies.get('permission') & 1 ? (
                        <li>Administrace</li>
                    ) : (
                        <div />
                    )}
                    {this.props.cookies.get('permission') & 2 ? (
                        <li>Práce s rejstříky</li>
                    ) : (
                        <div />
                    )}
                    {this.props.cookies.get('permission') & 4 ? (
                        <li>Prohlížení záznamů</li>
                    ) : (
                        <div />
                    )}
                    {this.props.cookies.get('permission') & 8 ? (
                        <li>Redakční systém</li>
                    ) : (
                        <div />
                    )}
                </ul>
                <p>
                    ...
                    <span className={styles.hiddenText}>
                        {this.props.cookies.get('sessionID')}
                    </span>
                </p>
                <Button
                    variant="contained"
