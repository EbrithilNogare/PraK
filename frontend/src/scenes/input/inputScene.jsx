    ...
    render() {
        return (
            <div className={styles.InputScene}>
                <Switch>
                    <Route path="/prak/input/metadata">
                        {' '}
                        <Metadata />{' '}
                    </Route>

                    <Route path="/prak/input/corporation">
                        {' '}
                        <Corporation />{' '}
                    </Route>
                    <Route path="/prak/input/creation">
                        {' '}
                        <Creation />{' '}
                    </Route>
                    <Route path="/prak/input/family">
                        {' '}
                        <Family />{' '}
                    </Route>
                    <Route path="/prak/input/geographic">
                        {' '}
                        <Geographic />{' '}
                    </Route>
                    <Route path="/prak/input/keyword">
                        {' '}
                        <Keyword />{' '}
                    </Route>
                    <Route path="/prak/input/person">
                        {' '}
                        <Person />{' '}
                    </Route>
                    <Route path="/prak/input/subject">
                        {' '}
                        <Subject />{' '}
                    </Route>
                </Switch>
