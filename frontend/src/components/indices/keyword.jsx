            ...
            >
                ...
                <div className={styles.body}>
                    ...
                    <FoldablePaper className={styles.dataBlock}>
                        ...
                        <Multiplier>
                            <KeywordComboBox
                                {...this.createFieldProps('associative')}
                            />
                        </Multiplier>
                    </FoldablePaper>
                    <FoldablePaper className={styles.dataBlock}>
                        ...
                        />
                        <TextField
                            {...this.createFieldProps('founding_subject')}
                        />
                        <SubjectComboBox
                            {...this.createFieldProps('founding_event')}
                        />
                        <KeywordComboBox
                            {...this.createFieldProps('founding_keyword')}
                        />
                        <TextField
                            {...this.createFieldProps(
                    ...
                    <FoldablePaper className={styles.dataBlock}>
                        ...
                        />
                        <TextField
                            {...this.createFieldProps('cancellation_subject')}
                        />
                        <SubjectComboBox
                            {...this.createFieldProps('cancellation_event')}
                        />
                        <KeywordComboBox
                            {...this.createFieldProps('cancellation_keyword')}
                        />
                        <TextField
                            {...this.createFieldProps(
