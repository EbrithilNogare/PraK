            ...
            >
                ...
                <div className={styles.body}>
                    ...
                    <FoldablePaper className={styles.dataBlock}>
                        ...
                        <Multiplier>
                            <GeographicComboBox
                                {...this.createFieldProps('locality')}
                            />
                        </Multiplier>
                        ...
                        <Multiplier>
                            <GeographicComboBox
                                {...this.createFieldProps('related_location')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <PersonComboBox
                                {...this.createFieldProps('owner_person')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <CorporationComboBox
                                {...this.createFieldProps('owner_corporation')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <CreationComboBox
                    ...
                    <FoldablePaper className={styles.dataBlock}>
                        ...
                        />
                        <TextField
                            {...this.createFieldProps('first_mention_subject')}
                        />
                        <TextField
                            {...this.createFieldProps(
                        ...
                        <TextField
                            {...this.createFieldProps(
                                'first_realization_chronological_specification'
                            )}
                        />
                    </FoldablePaper>
                    <FoldablePaper className={styles.dataBlock}>
                        ...
                        />
                        <TextField
                            {...this.createFieldProps('last_mention_subject')}
                        />
                        <TextField
                            {...this.createFieldProps(
                        ...
                        />
                        <SubjectComboBox
                            {...this.createFieldProps('last_realization_event')}
                        />
                        <TextField
                            {...this.createFieldProps(
                        ...
                        <TextField
                            {...this.createFieldProps(
                                'last_realization_chronological_specification'
                            )}
                        />
                    </FoldablePaper>
                    <FoldablePaper className={styles.dataBlock}>
                        ...
                        <Multiplier>
                            <GeographicComboBox
                                {...this.createFieldProps('location_change')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <TextField
                                {...this.createFieldProps(
                                    'change_chronological_specification'
                                )}
                            />
                        </Multiplier>
                    </FoldablePaper>
