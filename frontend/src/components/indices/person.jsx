            ...
            >
                ...
                <div className={styles.body}>
                    <FoldablePaper className={styles.dataBlock}>
                        ...
                        <LabeledCheckbox
                            {...this.createFieldProps('born_year_notKnown')}
                        />
                        <RegExpField {...this.createFieldProps('born_date')} />
                        <LabeledCheckbox
                            {...this.createFieldProps('born_date_notKnown')}
                        />
                        <GeographicComboBox
                            {...this.createFieldProps('born_place')}
                        />
                        <TextField {...this.createFieldProps('death_year')} />
                        <LabeledCheckbox
                            {...this.createFieldProps('death_year_notKnown')}
                        />
                        <RegExpField {...this.createFieldProps('death_date')} />
                        <LabeledCheckbox
                            {...this.createFieldProps('death_date_notKnown')}
                        />
                        <GeographicComboBox
                            {...this.createFieldProps('death_place')}
                        />
                        <TextField {...this.createFieldProps('initials')} />
                        <TextField
                            {...this.createFieldProps('roman_numerals')}
                        />
                        <KeywordComboBox
                    ...
                    <FoldablePaper className={styles.dataBlock}>
                        ...
                        <TextField
                            {...this.createFieldProps('bibliographical_note')}
                        />
                    </FoldablePaper>
                    <FoldablePaper className={styles.dataBlock}>
                        {' '}
                    ...
                    <FoldablePaper className={styles.dataBlock}>
                        ...
                        <Multiplier>
                            <KeywordComboBox
                                {...this.createFieldProps('domain_branch')}
                            />
                        </Multiplier>
                    </FoldablePaper>
                    <FoldablePaper className={styles.dataBlock}>
                    ...
                    <FoldablePaper className={styles.dataBlock}>
                        ...
                        <Multiplier>
                            <StaticComboBox
                                {...this.createFieldProps('language_country')}
                            />
                        </Multiplier>
                    </FoldablePaper>
                    <FoldablePaper className={styles.dataBlock}>
                        ...
                        <Multiplier>
                            <PersonComboBox
                                {...this.createFieldProps('parents')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <PersonComboBox
                                {...this.createFieldProps('siblings')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <FamilyComboBox
                                {...this.createFieldProps('family')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <CorporationComboBox
                                {...this.createFieldProps('membreship')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <KeywordComboBox
                                {...this.createFieldProps('employment')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <CorporationComboBox
                                {...this.createFieldProps('affiliation')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <CreationComboBox
                                {...this.createFieldProps('important_creation')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <SubjectComboBox
                                {...this.createFieldProps('important_event')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <TextField
                                {...this.createFieldProps('marriage_start')}
                            />
                            <TextField
                                {...this.createFieldProps('marriage_end')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <CorporationComboBox
                                {...this.createFieldProps('study')}
                            />
                        </Multiplier>
                    </FoldablePaper>
                    <FoldablePaper className={styles.dataBlock}>
