            ...
            >
                ...
                <div className={styles.body}>
                    ...
                    <FoldablePaper className={styles.dataBlock}>
                        ...
                        <Multiplier>
                            <SubjectComboBox
                                {...this.createFieldProps('sup_event')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <SubjectComboBox
                                {...this.createFieldProps('sub_event')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <PersonComboBox
                        ...
                        <Multiplier>
                            <GeographicComboBox
                                {...this.createFieldProps('related_place')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <GeographicComboBox
                                {...this.createFieldProps('venue')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <PersonComboBox
                                {...this.createFieldProps('organizator_person')}
                            />
                        </Multiplier>
                        <Multiplier>
                            <CorporationComboBox
