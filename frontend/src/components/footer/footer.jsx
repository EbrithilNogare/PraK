			...
			<div className={styles.footer}>
				<div>
					...
					<ul><li><NavLink to="/prak/login">
						{t("footer.loggedUser")} {this.props.cookies.get("user")}
					</NavLink></li></ul>
				</div>
				...
				<div>
					{(this.props.cookies.get("permission") & 2) > 0 && <ul>
						...
						<li> <NavLink to="/prak/input/geographic">{t("footer.geographic")} </NavLink> </li>
						<li> <NavLink to="/prak/input/keyword">{t("footer.keyword")}</NavLink> </li>
						<li> <NavLink to="/prak/input/person">{t("footer.person")}</NavLink> </li>
						<li> <NavLink to="/prak/input/subject">{t("footer.subject")}</NavLink> </li>
						<li> <NavLink to="/prak/input/family">{t("footer.family")}</NavLink> </li>
					</ul>}
				</div>
			</div>
		)
