...
class Prak extends React.Component {
    ...
    setLoginCookies = (sessionID, data) => {
        ...
        this.props.cookies.set('userID', data._id, {
            path: '/',
            expires: new Date(data.sessionExpiration),
        })
                            ...
                            <I18nextProvider i18n={i18n}>
                                <Router>
                                    ...
                                    <Switch>
                                        ...
                                        <Route path="/prak/show">
                                            <ShowScene />
                                        </Route>
                                        <Route path="/prak/search">
                                            <SearchScene />
                                        </Route>

                                        <Route path="/prak/contacts">
                                            <ContactsPage />
                                        </Route>

                                        <Route
                                            path="/prak/maps/:mapID"
                                            render={({ match }) => (
                                                <MapsScene
                                                    mapID={match.params.mapID}
                                                />
                                            )}
                                        ></Route>
                                        <Route
                                        ...
                                        ></Route>
                                        <Route
                                            path="/prak/pageCategory/:categoryName"
                                            render={({ match }) => (
                                                <PageCategoryList
                                                    pageCategoryName={
                                                        match.params
